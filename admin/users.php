...
<table>
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
    <tr>
      ...
      <td align="center"><a href="users_edit.php?id=<?php echo $record['id']; ?>">Edit<i class="fa fa-edit"></i></a></td>
      <td align="center">
        <?php if( $_SESSION['id'] != $record['id'] ): ?>
          <a href="users.php?delete=<?php echo $record['id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this user?');">Delete<i class="fa fa-trash"></a>
        <?php endif; ?>
      </td>
